      ...
      <div class="card">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                    $nomor = 1;
                    if (isset($transaksi) && is_array($transaksi)) { // Memastikan $Barang terdefinisi
                        foreach ($transaksi as $item) {
                ?>
                <tr>
                    <th scope="row"><?php echo $nomor++; ?></th>
                    <td><?php echo $item["id_trans"]; ?></td> 
                    <td><?php echo $item["id_plg"]; ?></td> 
                    ...
                    <a href="index.php?page=delete_transaksi&id_trans=<?= $item['id_trans'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus barang ini?')">Hapus</a>
